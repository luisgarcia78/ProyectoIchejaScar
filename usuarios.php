                      ...
                      <table class="table">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>Thornton</td>
                            <td>@fat</td>
                            <td><a href="ActualizarUsu.html"><i class="bi bi-pencil-square"></i></a>
                              <button class="borrar" type="submit"><i class="bi bi-trash3-fill"></i> </button></td>  
                          </tr>
                        </tbody>
                      </table>
                              <!-- Botón de agregar -->
                                <div>
                                        <a href="AgregarUsuario.html"><button class="btn-add btn-lg" title="Boton para guardar" type="submit">
