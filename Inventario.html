                      ...
                      <table class="table">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td>@twitter</td>
                              <td>lorem</td>
                              <td><a href="ActualizarInventario.html"><i class="bi bi-pencil-square"></i></a>
                                <button class="borrar" type="submit" title="borrar un registro"><i class="bi bi-trash3-fill"></i> </button></td> 
                          </tbody>
                        </table> 
                  <!-- Botón de agregar -->
                  <div>
