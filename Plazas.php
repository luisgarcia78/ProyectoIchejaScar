...
<body>
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><a href="ActualizarPlazas.php"><i class="bi bi-pencil-square"></i></a>
                              <button class="borrar" id="eliminarBtnPlaza" type="click"><i class="bi bi-trash3-fill"></i></button>
                            </td> 
                          </tr>
                        </tbody>
                      </table>
                              <!-- Botón de agregar -->
                                <div>
                                        <a href="AgregarPlaza.php"><button class="btn-add btn-lg" title="Boton para guardar">
  ...
  Swal.fire({
    ...
    <script src="/js/accionesjs/plazas/btnEliminar"></script> 
