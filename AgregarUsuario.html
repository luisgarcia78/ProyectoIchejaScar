        ...
        <div class="row">
          <div class="barra-lateral col-12 col-sm-auto">
            <nav class="menu d-flex d-sm-block justify-content-center flex-wrap">
                ...
                <a href="usuarios.html"><i><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-person-badge-fill" viewBox="0 0 16 16">
                  <path d="M2 2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V2zm4.5 0a.5.5 0 0 0 0 1h3a.5.5 0 0 0 0-1h-3zM8 11a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm5 2.755C12.146 12.825 10.623 12 8 12s-4.146.826-5 1.755V14a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1v-.245z"/>
                </svg></i><span>Usuario</span></a>
                
                <a href="Coordinacion.html"><i><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-diagram-3-fill" viewBox="0 0 16 16">
                  ...
                  <a href="Departamentos.html"><i><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-building-fill" viewBox="0 0 16 16">
                  ...
                  <a href="Plazas.html"><i><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-people-fill" viewBox="0 0 16 16">
            ...
            <form class="form">
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            <label for="no.usu" class="form-label">No. usuario:</label>
                            <input type="number" id="no.usu" name="no.usu" class=""><br><br>
            
                            <label for="nom.usuario" class="form-label">Nombre del usuario:</label>
                            <input type="text" id="nom.usuario" name="nom.usuario" class=""><br><br>

                            <label for="No.dep" class="form-label">Numero de telefono:</label>
                            <input type="text" id="No.dep" name="No.dep" class=""><br><br>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" id="No.usu" name="No.usu" class=""><br><br>
                    ...
                    <div style="text-align: center;">
                        <div style="display: inline-block;">
                          <button class="BotonGuardar" onclick="window.location.href='usuarios.html';" type="submit" style="vertical-align: middle;">
                          ...
                          <a class="BotonGuardar" href="usuarios.html" role="button" style="vertical-align: middle; "onclick="confirmCancel()">
                          ...
                          <a class="BotonGuardar" href="usuarios.html" role="button" style="vertical-align: middle;">
