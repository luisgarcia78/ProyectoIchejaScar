                    ...
                    <div class="div_principa">
                        ...
                        <form class="d-flex" role="search" style="width: 100%;">
                          ...
                          <div>
                            <button class="btn btn-outline-success" type="submit">
                              <i><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
                          ...
                          <div class="row" style="margin-left: 4%;">
                            ...
                            <div class="col-md-2" style="margin-left:20%; padding-left: 25%; text-align: justify; width: 100%;">
                          ...
                          <div class="col-md-1" style="margin-right: 20%; margin-top: 2.7%;">
                            <div class="form-check">
                              <input class="form-check-input" type="checkbox" value="" id="checkbox4">
                              <label class="form-check-label" for="checkbox4">
                                Direccion fisica
                        ...
                        <table class="table">
                            <thead >
                              <tr>
                                <th scope="col">N/C</th>
                                <th scope="col">Clave Coordinacion</th>
                                <th scope="col">Clav SEG</th>
                                <th scope="col">Estado</th>
                                <th scope="col">Municipio</th>
                                <th scope="col">Nombre</th>
                                <th scope="col">Direccion</th>
                                <th scope="col">Direccion física</th>
                                <th scope="col">Direccion usuario</th>
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td>@twitter</td>
                                <td>lorem</td>
                                <td><a href="ActualizarDepa.html"><i class="bi bi-pencil-square"></i></a></td>
                                ...
                                <div>
                                        <a href="AgregarDepa.html"><button class="btn-add btn-lg">
                                          <i class="fas fa-plus-circle "></i> Agregar
                                                ...
                                                <!-- Botón de editar
                                        <a href="EditarDepa.html"> <button class="btn-edit btn-lg">
