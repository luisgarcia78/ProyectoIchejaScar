                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="number" id="clave1" name="clave1" class=""><br><br>
                    ...
                    <div style="text-align: center;">
                        <div style="display: inline-block;">
                          <button class="BotonGuardar" onclick="window.location.href='Departamentos.html';" type="submit" style="vertical-align: middle;">
                          ...
                          <a href="Departamentos.html"> <button class="BotonGuardar" id="cancelBtndepa" style="vertical-align: middle;" type="button">
                          ...
                          <a class="BotonGuardar" href="Departamentos.html" role="button" style="vertical-align: middle;">
