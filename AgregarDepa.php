                ...
                <div class="container">
                    ...
                    <div style="text-align: center;">
                        <div style="display: inline-block;">
                          <button class="BotonGuardar" onclick="window.location.href='Departamentos.php';" type="submit" style="vertical-align: middle;">
...
<<<<<<< HEAD:AgregarDepa.php
                          <a href="Departamentos.php"> <button class="BotonGuardar" id="cancelBtndepa" style="vertical-align: middle;" type="button">
=======
                          <a href="Departamentos.html"> <button class="BotonGuardar" id="cancelBtndepa" style="vertical-align: middle;" type="button">
>>>>>>> ac09b7f3fa1df8745636b7aab90b986485128813:AgregarDepa.html
